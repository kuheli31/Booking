Frontend:-
installed -> vite , tailwind , react-router dom , npm install @headlessui/react , npm install @heroicons/react , npm install firebase , npm install -g json-server,
backend view-> json-server --watch db.json --port 8000
